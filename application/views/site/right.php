        ...
        <ul class="news">
            <li>
                <a href="news/view/4.html" title="Mỹ tăng cường không kích Iraq">
                    <img src="<?php echo public_url(); ?>site/images/li.png"> Mỹ tăng cường không kích Iraq </a>
            </li>
            <li>
                <a href="news/view/3.html" title="Hà Nội: CSGT tìm người thân giúp cháu bé 8 tuổi đi lạc">
                    <img src="<?php echo public_url(); ?>site/images/li.png"> Hà Nội: CSGT tìm người thân giúp cháu bé 8 tuổi đi lạc </a>
            </li>
            <li>
                <a href="news/view/2.html" title="Arsenal đồng ý bán Vermaelen cho Barcelona">
                    <img src="<?php echo public_url(); ?>site/images/li.png"> Arsenal đồng ý bán Vermaelen cho Barcelona </a>
            </li>
            <li>
                <a href="news/view/1.html" title="Nhà lầu siêu xe hàng mã ế sưng, đồ chơi biển đảo hút khách">
                    <img src="<?php echo public_url(); ?>site/images/li.png"> Nhà lầu siêu xe hàng mã ế sưng, đồ chơi biển đảo hút khách </a>
            </li>
        </ul>
    </div>
</div>
    ...
    <div class="content-box">
        <center>
            ...
            <a href="http://www.histats.com" target="_blank" title="hit counter">
                ...
                <div id="histats_counter_7316" style="display: block;">
                    <a href="http://www.histats.com/viewstats/?sid=2138481&amp;ccid=401" target="_blank">
                        <canvas id="histats_counter_7316_canvas" width="119" height="81"></canvas>
                    </a>
                </div>
            </a>
            <!-- Histats.com  END  -->
